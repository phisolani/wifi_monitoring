...
def initialize_stats_files():
    try:
        ...
        wtp_aggregated_stats_file = open('stats/wtp_aggregated_stats_' + str(socket.gethostname()) + '.json', 'w+')
...
def add_wtp_raw_stats_to_file(wtp_raw_stats):
    try:
        ...
        wtp_raw_stats_file = open('stats/wtp_raw_stats_' + str(socket.gethostname()) + '.json', 'w+')
